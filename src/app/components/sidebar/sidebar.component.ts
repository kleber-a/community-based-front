...
export class SidebarComponent {
  ...
  readonly navigationItems: NavigationItem[] = [
    ...
    { id: 'agenda', label: 'Agenda', route: '/agenda', disable: true, icon: 'M7 2v2H5a2 2 0 0 0-2 2v1h18V6a2 2 0 0 0-2-2h-2V2h-2v2H9V2H7Zm14 7H3v11a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V9ZM7 12h4v4H7v-4Z' },
    { id: 'insights', label: 'Insights', route: '/insights', disable: true, icon: 'M11 2h2v20h-2V2ZM5.5 8.5 7 7l3 3-1.5 1.5-3-3Zm13 0L17 10l-3-3 1.5-1.5 3 3Z' },
  ];
}
